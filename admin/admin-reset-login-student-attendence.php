...
$query0 = "select * from logins where type = 'studentattendence'";
...
if(isset($_POST['submit']))
{
    ...
    $query = "select * from logins where username = '$username' and type !== 'studentattendence' ";
    ...
    if( strlen($username) < 6 )
    {
        ...
        header("refresh: 2; url=admin-reset-login-student-attendence.php");
    }
    ...
    else
    {
        ...
        $query1 = "update logins set username = '$username', password = '$password' where type = 'studentattendence'";
...
<title> Admin | Reset Student Attendence Username & Password  </title>
                ...
                <div class="card form-card" style="margin-top:-20px !important;">
                    <div class="card-body student-card-body">
                        ...
                        <div class="d-md-flex align-items-center">
                            <div>
                                <h4 class="card-title">Student Attendence Reset Username & Password</h4>
                                <h5 class="card-subtitle">Change Student Attendence Username & Password</h5>
                            </div>
                        </div>
                        <!-- title -->
                    </div>
