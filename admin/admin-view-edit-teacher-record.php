<?php
    ...
    if(isset($_GET['deleteId']))
    {
            ...
            $query2 = "delete from teacher where t_id = '$deleteId' ";
    
            mysqli_query($con, $query2);

            $msg="Teacher Deleted Successfully !";
            $_SESSION['deleteMsg'] = $msg;
            header("refresh: 2; url=admin-view-edit-teacher-record.php");
    }


?>  

<title> Admin | View & Edit Teacher Record </title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
        <div class="">
            <h1 class="page-heading">Edit Teacher Record</h1>
    ...
    <div class="row mt-2 mb-0">
        ...
        <div class="col-md-4">
            ...
            <label for="sclass" >Search Teacher</label>
            ...
            <input style="margin-top:0px !important" type="submit" value="Search" id="searchBtn" class="btn btn-sm float-right mt-3 btn-search" name="searchByRollNo">                        
                ...
                <?php
                    ...
                    $query = "select * from teacher order by t_id desc limit 5";
    ...
    $(document).ready(() => {
        ...
        $('#searchBtn').click(() => {
            ...
            jQuery.ajax({
                ...
                url:'ajax/admin-search-view-edit-teacher-record.php',
                type: 'POST',
                data:{
                    search:search
                },
