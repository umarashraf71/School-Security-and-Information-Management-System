...
<title> Admin | Add Teacher Fingerprint </title>
...
if(isset($_POST['submit']))
{
    ...
    $query = "update teacher set fingerprint_code = '$fingerprint' where t_id = $t_id ";
    $result = mysqli_query($con, $query);

    if($result)
    {
        $msg="Teacher details and fingerprint added Successfully";
                    ...
                    <div class="card-body student-card-body">
                        ...
                        <div class="d-md-flex align-items-center">
                            <div>
                                ...
                                <h5 class="card-subtitle">Add Teacher Fingerprint</h5>
                            </div>
                        </div>
                        <!-- title -->
                    </div>
