      ...
      <div class="form-card-container" >
        ...
        <div class="student-reg-form">
            ...
            <div class="row profile-details pl-5 pr-5 pb-5 pt-3">
                ...
                <div class="col-md-6 mb-3">
                    <span> Teacher Name : </span> <?php echo $row['name'];  ?>
                </div>

                <div class="col-md-6 mb-3">
                    <span> Teacher Contact : </span> <?php echo $row['contact'];  ?>
                </div>

                <div class="col-md-6 mb-3">
                    <span> Residential Address : </span> <?php echo $row['address'];  ?>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <span> Qualification : </span> <?php echo $row['qualification'];  ?> 
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <span> Medical Allowance (Rs) : </span> <?php echo $row['medical_allowance'];  ?> 
                </div>

                <div class="col-md-6 mb-3">
                    <span> Transport Allowance (Rs) : </span> <?php echo $row['transport_allowance'];  ?> 
                </div>
