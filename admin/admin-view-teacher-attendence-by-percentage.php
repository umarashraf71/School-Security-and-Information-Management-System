...
<title>Admin | View Teacher Attendence Percentage</title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
    <div class="">
        <h1 class="page-heading">View Teacher Attendence Percentage</h1>
   ...
   $(document).ready(function(){
       ...
       $('#searchBtn').click(function(){
           ...
           jQuery.ajax({
               ...
               url:'ajax/admin-search-view-teacher-attendence-by-percentage.php',
               type: "POST",
               data:{
                   startdate:startdate,
                   enddate:enddate, 
