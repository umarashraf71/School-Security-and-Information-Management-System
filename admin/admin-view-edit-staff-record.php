<?php
    ...
    if(isset($_GET['deleteId']))
    {
            ...
            $query2 = "delete from staff where st_id = '$deleteId' ";
    
            mysqli_query($con, $query2);

            $msg="Staff Member Deleted Successfully !";
            $_SESSION['deleteMsg'] = $msg;
            header("refresh: 2; url=admin-view-edit-staff-record.php");
    }
...
<title> Admin | View & Edit Staff </title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
        <div class="">
            <h1 class="page-heading">Edit Staff Member Record</h1>
    ...
    <div class="col-md-12 mt-lg-2  mb-0">   
        ...
        <?php } ?>
                ...
                <!-- Notify message	-->
		<?php if(!empty($_SESSION['successMsg1'])) { ?>
 
            <div class="alert alert-success 
                        text-center offset-md-3 
                        col-md-6" id = "message">
                <strong style="font-size:16px;">
                    <?php echo htmlentities($_SESSION['successMsg1']);?>
                    <?php echo htmlentities($_SESSION['successMsg1']="");?>
                </strong>
            </div>
    ...
    <div class="row mt-2 mb-0">
        ...
        <div class="col-md-4">
            ...
            <label for="sclass" >Search Staff Member</label>
            ...
            <input style="margin-top:0px !important" type="submit" value="Search" id="searchBtn" class="btn btn-sm float-right mt-3 btn-search" name="searchByRollNo">                        
                    ...
                    <?php
                        ...
                        $query = "select * from staff where type != 'admin' order by st_id desc limit 5 ";
                            ...
                            <table class="table v-middle">
                                ...
                                <?php
                                    ...
                                    else
                                    {
                                        ...
                                        echo "<h3 class='pt-5'> No Staff Record Exists !</h3>";
                                        echo "</div>";
                                    }
        ...
        $(document).ready(() => {
            ...
            $('#searchBtn').click(() => {
                ...
                jQuery.ajax({
                    ...
                    url:'ajax/admin-search-view-edit-staff-record.php',
                    type: 'POST',
                    data:{
                        search:search
                    },
