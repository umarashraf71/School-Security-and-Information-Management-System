...
$count = 0;
    ...
    else
    {
        ...
        if(!empty( $_POST['scnic'] ) && !empty($_POST['sdate']))
        {
            ...
            $query = "select * from staff_attendence where st_cnic = '$scnic' and date = '$date' ";
                ...
                <div class="table-responsive">
                    ...
                    ?>
                            <tr>
                                ...
                                <?php echo "<strong class='text-success' id='pdisplaystatus-".$row['st_a_id']."'>"; ?> 
                                    <?php echo ucfirst($row['status']); ?>
                                <?php echo "</strong>"; ?>

                                <?php echo "<strong id='displaystatus-".$row['st_a_id']."'></strong>"; ?>
                                ...
                                <?php echo "<strong class='text-danger' id='pdisplaystatus-".$row['st_a_id']."'>"; ?> 
                                    <?php echo ucfirst($row['status']); ?>
                                <?php echo "</strong>"; ?>
                                ...
                                <?php echo "<strong class='text-primary' id='pdisplaystatus-".$row['st_a_id']."'>"; ?> 
                                    <?php echo ucfirst($row['status']); ?>
                                <?php echo "</strong>"; ?>
                               ...
                               <?php
                                ...
                                <?php
                                    ...
                                    if($row['status'] == 'present'){
                                        ...
                                        echo "<a rel='{$id}' class='btn btn-success btn-sm btn-action mr-1 present-link disabled' href='javascript:void(0)' id='pbutton-".$row['st_a_id']."' >Present</a>";
                                        echo   "<a rel='{$id}' class='btn btn-primary btn-sm btn-action mr-1 leave-link' href='javascript:void(0)' id='lbutton-".$row['st_a_id']."' >Leave</a>";
                                        echo   "<a rel='{$id}' class='btn btn-danger btn-sm btn-action absent-link' href='javascript:void(0)' id='abutton-".$row['st_a_id']."' >Absent</a>";
                                        ...
                                        echo "<a rel='{$id}' class='btn btn-success btn-sm btn-action mr-1 present-link' href='javascript:void(0)' id='pbutton-".$row['st_a_id']."'>Present</a>";
                                        echo   "<a rel='{$id}' class='btn btn-primary btn-sm btn-action mr-1 leave-link' href='javascript:void(0)' id='lbutton-".$row['st_a_id']."'>Leave</a>";
                                        echo   "<a rel='{$id}' class='btn btn-danger btn-sm btn-action absent-link disabled' href='javascript:void(0)' id='abutton-".$row['st_a_id']."'>Absent</a>";
                                        ...
                                        echo "<a rel='{$id}' class='btn btn-success btn-sm btn-action mr-1 present-link' href='javascript:void(0)' id='pbutton-".$row['st_a_id']."'>Present</a>";
                                        echo   "<a rel='{$id}'  class='btn btn-primary btn-sm btn-action mr-1 leave-link disabled' href='javascript:void(0)' id='lbutton-".$row['st_a_id']."'>Leave</a>";
                                        echo   "<a rel='{$id}' class='btn btn-danger btn-sm btn-action absent-link ' href='javascript:void(0)' id='abutton-".$row['st_a_id']."'>Absent</a>";
...
<?php
    ...
    else
    {
        ...
        {
            echo "<div class='col-md-12 text-center mt-5'>";
            echo "<h3 class='pt-5'> No Member Record Found !</h3>";
            echo "</div>";
        }
