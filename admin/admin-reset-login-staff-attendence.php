...
$query0 = "select * from logins where type = 'staffattendence'";
...
if(isset($_POST['submit']))
{
    ...
    $query = "select * from logins where username = '$username' and type !== 'staffattendence' ";
    ...
    if( strlen($username) < 6 )
    {
        ...
        header("refresh: 2; url=admin-reset-login-staff-attendence.php");
    }
    ...
    else
    {
        ...
        $query1 = "update logins set username = '$username', password = '$password' where type = 'staffattendence'";
...
<title> Admin | Reset Staff Attendence Username & Password  </title>
                ...
                <div class="card form-card" style="margin-top:-20px !important;">
                    <div class="card-body student-card-body">
                        ...
                        <div class="d-md-flex align-items-center">
                            <div>
                                <h4 class="card-title">Staff Attendence Reset Username & Password</h4>
                                <h5 class="card-subtitle">Change Staff Attendence Username & Password</h5>
                            </div>
                        </div>
                        <!-- title -->
                    </div>
