<?php
	...
	if(isset($_GET['deleteId']))
    {
            ...
            $query2 = "delete from student where s_id = '$deleteId' ";
        
            mysqli_query($con, $query2);
        
            $msg="Student Deleted Successfully !";
            $_SESSION['deleteMsg'] = $msg;
            header("refresh: 2; url=admin-view-edit-student-record.php");
    }


?>  

<title> Admin | View & Edit Student Record </title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
        <div class="">
            <h1 class="page-heading">Edit Student Record</h1>
        ...
        <div class="col-md-4">
            ...
            <input style="margin-top:0px !important" type="submit" value="Search" id="searchBtn" class="btn btn-sm float-right mt-3 btn-search" name="searchByRollNo">                        
                        ...
                        <?php
                            ...
                            $query = "select * from student order by s_id desc limit 5";
        ...
        $(document).ready(function(){
            ...
            $('#searchBtn').click(function(){
                ...
                jQuery.ajax({
                    ...
                    url:'ajax/admin-search-view-edit-student-record.php',
                    type: "POST",
                    data:{
                        sclass:sclass,
                        ssection:ssection,
