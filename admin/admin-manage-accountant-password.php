...
$query0 = "select * from logins where type = 'accountant'";
...
if(isset($_POST['submit']))
{
    ...
    $query = "select * from logins where username = '$username' and type != 'accountant'";
    ...
    if( strlen($username) < 6 )
    {
        ...
        header("refresh: 2; url=admin-manage-accountant-password.php");
    }
    ...
    else
    {
        ...
        $query1 = "update logins set username = '$username', password = '$password' where type = 'accountant'";
...
<title> Accountant | Reset Username & Password  </title>
                ...
                <div class="card form-card" style="margin-top:-20px !important;">
                    <div class="card-body student-card-body">
                        ...
                        <div class="d-md-flex align-items-center">
                            <div>
                                <h4 class="card-title">Accountant Reset Username & Password</h4>
                                <h5 class="card-subtitle">Change Accountant Username & Password</h5>
                            </div>
                        </div>
                        <!-- title -->
                    </div>
