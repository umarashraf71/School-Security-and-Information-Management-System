...
$query0 = "select * from logins where type = 'teacherattendence'";
...
if(isset($_POST['submit']))
{
    ...
    $query = "select * from logins where username = '$username' and type !== 'teacherattendence' ";
    ...
    if( strlen($username) < 6 )
    {
        ...
        header("refresh: 2; url=admin-reset-login-teacher-attendence.php");
    }
    ...
    else
    {
        ...
        $query1 = "update logins set username = '$username', password = '$password' where type = 'teacherattendence'";
...
<title> Librarian | Reset Teacher Attendence Username & Password  </title>
                ...
                <div class="card form-card" style="margin-top:-20px !important;">
                    <div class="card-body student-card-body">
                        ...
                        <div class="d-md-flex align-items-center">
                            <div>
                                <h4 class="card-title">Teacher Attendence Reset Username & Password</h4>
                                <h5 class="card-subtitle">Change Teacher Attendence Username & Password</h5>
                            </div>
                        </div>
                        <!-- title -->
                    </div>
