...
$query0 = "select * from logins where type = 'labhead'";
...
if(isset($_POST['submit']))
{
    ...
    $query = "select * from logins where username = '$username' and type != 'labhead'";
    ...
    if( strlen($username) < 6 )
    {
        ...
        header("refresh: 2; url=admin-manage-labhead-password.php");
    }
    ...
    else
    {
        ...
        $query1 = "update logins set username = '$username', password = '$password' where type = 'labhead'";
...
<title> Admin | Reset Labhead Username & Password  </title>
                ...
                <div class="card form-card" style="margin-top:-20px !important;">
                    <div class="card-body student-card-body">
                        ...
                        <div class="d-md-flex align-items-center">
                            <div>
                                <h4 class="card-title">Labhead Reset Username & Password</h4>
                                <h5 class="card-subtitle">Change Labhead Username & Password</h5>
                            </div>
                        </div>
                        <!-- title -->
                    </div>
