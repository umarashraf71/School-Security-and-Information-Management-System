...
<title> Admin | Add Staff Member Fingerprint </title>
...
if(isset($_POST['submit']))
{
    ...
    $query = "update staff set fingerprint_code = '$fingerprint' where st_id = $st_id ";
    $result = mysqli_query($con, $query);

    if($result)
    {
        $msg="Staff Member details and fingerprint added Successfully";
                    ...
                    <div class="card-body student-card-body">
                        ...
                        <div class="d-md-flex align-items-center">
                            <div>
                                ...
                                <h5 class="card-subtitle">Add Staff Member Fingerprint</h5>
                            </div>
                        </div>
                        <!-- title -->
                    </div>
