...
<title> Admin | View & Edit Staff Attendence </title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
        <div class="">
            <h1 class="page-heading">Edit Staff Attendence</h1>
    ...
    <div class="row mt-2 mb-0 p-1">
        ...
        <div class="col-md-6">     
            <div class="form-group has-search" >
                <label for="sclass" >Enter Staff Member CNIC</label>
...
$(document).ready(()=>{
 ...
 var interval2;
    ...
    $.ajax({
        ...
        url:'ajax/admin-show-staff-attendence.php',
        type:'POST',
    ...
    $('#searchBtn').click(function(){
        ...
        jQuery.ajax({
            ...
            url:'ajax/admin-search-view-edit-staff-attendence-record.php',
            type: "POST",
            data:{
                scnic:scnic,
                sdate:sdate
