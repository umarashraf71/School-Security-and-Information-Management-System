...
if(isset($_GET['deleteId']))
{
        ...
        $query2 = "delete from student_voucher where s_v_id = '$deleteId' ";
    
        mysqli_query($con, $query2);
    
        $msg="Student Voucher Deleted Successfully !";
        $_SESSION['deleteMsg'] = $msg;
        header("refresh: 2; url=accountant-view-edit-student-voucher.php");
}
...
<title>Accountant | View & Edit Student Voucher</title>
...
$(document).ready(()=>{
    ...
    jQuery.ajax({
        ...
        url:'ajax/accountant-search-view-edit-student-voucher.php',
        type: "POST",
        data:{
            sclass:sclass,
            ssection:ssection,
