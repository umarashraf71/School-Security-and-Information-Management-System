...
<title>Accountant | View & Create Staff Pay Voucher</title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
    <div class="">
        <h1 class="page-heading">Create Staff Pay Voucher</h1>
...
jQuery.ajax({
    ...
    url:'ajax/accountant-search-view-create-staff-pay-voucher.php',
    type: "POST",
    data:{
        cnic:cnic
    },
