...
<title>Accountant | View & Edit Staff Pay Record</title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
    <div class="">
        <h1 class="page-heading">Manage Staff Pay Record</h1>
...
jQuery.ajax({
    ...
    url:'ajax/accountant-search-view-edit-staff-pay-record.php',
    type: "POST",
    data:{
        cnic:cnic
    },
