...
if(isset($_GET['deleteId']))
{
        ...
        $query2 = "delete from staff_voucher where st_v_id = '$deleteId' ";
    
        mysqli_query($con, $query2);
    
        $msg="Staff Member Voucher Deleted Successfully !";
        $_SESSION['deleteMsg'] = $msg;
        header("refresh: 2; url=accountant-view-edit-staff-pay-voucher.php");
}
...
<title>Accountant | View & Edit Staff Pay Voucher</title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
    <div class="">
        <h1 class="page-heading">Edit Staff Pay Voucher</h1>
        ...
        <div class="col-md-4">
            ...
            <input style="margin-top:0px !important" type="submit" value="Search" id="searchBtn" class="btn btn-sm float-right mt-3 btn-search" name="searchByRollNo">                        
                        ...
                        <?php
                            ...
                            $query = "select * from staff_voucher order by issue_date desc limit 7";
...
$(document).ready(()=>{
    ...
    jQuery.ajax({
        ...
        url:'ajax/accountant-search-view-edit-staff-pay-voucher.php',
        type: "POST",
        data:{
            cnic:cnic
        },
