...
include('../includes/config.php');
    ...
    else
    {
        ...
        if(!empty($_POST['sclass'] ) && !empty($_POST['ssection']) && empty($_POST['srollno']))
        {
            ...
            $query = "select * from student where class_id = '$class_id' and section = '$ssection' order by roll_no asc";
        ...
        if(!empty($_POST['sclass'] ) && !empty($_POST['ssection']) && !empty($_POST['srollno']))
        {
            ...
            $query = "select * from student where class_id = '$class_id' and section = '$ssection' and roll_no = '$srollno' order by roll_no asc ";
            $result = mysqli_query($con, $query);
                ...
                <div class="table-responsive">
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="accountant-create-single-student-voucher.php?id=<?php echo $row['s_id']; ?>" class="btn btn-success btn-sm btn-action mr-1">Create Voucher</a>
                                </td>
                            </tr>
