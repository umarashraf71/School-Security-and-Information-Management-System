...
$count = 0;
    ...
    else
    {
        ...
        if(!empty($_POST['sclass'] ) && !empty($_POST['ssection']) && !empty($_POST['sdate']) && empty($_POST['srollno']))
        {
            ...
            $query = "select * from student_voucher where class = '$class_id' and section = '$section' and issue_date = '$date' ";
        ...
        if(!empty($_POST['sdate']) && !empty($_POST['sclass'] ) && !empty($_POST['ssection']) && !empty($_POST['srollno']))
        {
            ...
            $query = "select * from student_voucher where class = '$class_id' and section = '$section' and issue_date = '$date' and roll_no = '$srollno' ";
            $result = mysqli_query($con, $query);
        ...
        else if(empty($_POST['sclass'] ) && empty($_POST['ssection']) && empty($_POST['srollno']) && !empty($_POST['sdate']))
        {
            ...
            $query = "select * from student_voucher where issue_date = '$date' ";
            $result = mysqli_query($con, $query);
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="accountant-edit-student-voucher.php?id=<?php echo $id ?>" class="btn btn-primary btn-sm btn-action mr-1">Edit</a>
                                    <a  onClick="return confirm('Are you sure you want to delete ?')"  
                                        href="accountant-view-edit-student-voucher.php?deleteId=<?php echo $id ?>" class="btn btn-danger btn-sm btn-action">Delete</a>    
                                </td>
                            </tr>
