...
include('../includes/config.php');
    ...
    if(empty($_POST['sclass'] ) && empty($_POST['ssection']) && empty($_POST['srollno']) && empty($_POST['sfeetype']))
    {
    ...
    else if(empty($_POST['sclass'] ) && !empty($_POST['ssection']) && empty($_POST['srollno']) && empty($_POST['sfeetype']))
    {
    ...
    else
    {
        ...
        //if class , section and feetype is selected 
        if(!empty($_POST['sclass'] ) && !empty($_POST['ssection']) && empty($_POST['srollno']) && !empty($_POST['sfeetype']))
        {
            
            $class_id = $_POST['sclass'];
            $ssection = $_POST['ssection'];
            $sfeetype = $_POST['sfeetype'];

            $query = "select * from student where class_id = '$class_id' and section = '$ssection' and fee_type = '$sfeetype' ";
            $result = mysqli_query($con, $query);
        ...
        //if class , section and rollno is selected 
        if(!empty($_POST['sclass'] ) && !empty($_POST['ssection']) && !empty($_POST['srollno']) && empty($_POST['sfeetype']))
        {
        ...
        //if class , section , feetype and roll no is selected
        if(!empty($_POST['sclass'] ) && !empty($_POST['ssection']) && !empty($_POST['srollno']) && !empty($_POST['sfeetype']))
        {
            ...
            $query = "select * from student where class_id = '$class_id' and section = '$ssection' and roll_no = '$srollno' and fee_type = '$sfeetype' ";
            $result = mysqli_query($con, $query);
                ...
                <div class="table-responsive">
                    <table class="table v-middle">
                        <thead >
                            <tr class="table-header">
                                ...
                                <th class="border-top-0">Father/Gaurdian Name</th>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="accountant-edit-manage-student-fee-record.php?id=<?php echo $row['s_id']; ?>" class="btn btn-primary btn-sm btn-action mr-1">Edit</a>
                                </td>
                            </tr>
