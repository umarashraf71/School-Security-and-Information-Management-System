...
{
        $viewId = $_GET['id'];
        $query = "select * from teacher_voucher where t_v_id = '$viewId' ";
...
<title>Accountant | View Teacher Pay Voucher</title>
            ...
            <div class="row profile-details  pb-4 pt-3 fee-voucher">
                ...
                <div class="col-md-12 mb-1 pt-3 mt-2 border-top">                    
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                        <?php echo $row['medical_allowance']; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 mb-1">                    
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                        <?php echo $row['transport_allowance']; ?>
                        </div>
                    </div>
                </div>
