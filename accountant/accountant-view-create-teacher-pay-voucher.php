...
<title>Accountant | View & Create Teacher Pay Voucher</title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
    <div class="">
        <h1 class="page-heading">Create Teacher Pay Voucher</h1>
    ...
    <div class="row mt-2 mb-0">
        ...
        <div class="col-md-4">
            ...
            <label for="sclass" >Search by CNIC</label>
                <input type="text" maxlength="15" class="form-control" name="cnic" id="cnic" placeholder="Enter CNIC i.e 35603-2006787-1">
            </div>
...
jQuery.ajax({
    ...
    url:'ajax/accountant-search-view-create-teacher-pay-voucher.php',
    type: "POST",
    data:{
        cnic:cnic
    },
