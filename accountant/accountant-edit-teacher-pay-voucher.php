...
if(isset($_GET['id']))
{
    ...
    $query = "select * from teacher_voucher where t_v_id = '$editId'";
...
if(isset($_POST['submit']))
{
    ...
    $query1 = "update teacher_voucher set issue_date = '$issuedate', medical_allowance = '$teacherMedicalAllowance', transport_allowance = '$teacherTransportAllowance', monthly_salary = '$teacherMonthlySalary', total_amount = '$totalamount' where t_v_id = '$editId' ";    

    $result1 = mysqli_query($con, $query1);

    if($result1)
    {
        $msg="Teacher Voucher Updated Successfully ";  
      ...
      <div class="form-card-container" >
                <div class="card form-card">
                    <div class="card-body student-card-body">
                        ...
                        <div class="d-md-flex align-items-center">
                            <div>
                                <h4 class="card-title">Edit Teacher Pay Voucher</h4>
        ...
        <form action="" method="POST" enctype="multipart/form-data" class="student-reg-form">
            ...
            <div class="form-group">
                ...
                <input type="number" value="<?php echo $row['transport_allowance']; ?>" name="teachertransportallowance" class="form-control" id="teachertransportallowance"
