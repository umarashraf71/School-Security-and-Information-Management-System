...
<title>Accountant | View & Edit Teacher Pay Record</title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
    <div class="">
        <h1 class="page-heading">Manage Teacher Pay Record</h1>
...
jQuery.ajax({
    ...
    url:'ajax/accountant-search-view-edit-teacher-pay-record.php',
    type: "POST",
    data:{
        cnic:cnic
    },
