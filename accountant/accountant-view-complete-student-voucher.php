...
if(isset($_GET['completeId']))
{
        ...
        $query2 = "update student_voucher set status = 'paid' where s_v_id = '$completeId'";
        mysqli_query($con, $query2);
    
        $msg="Status Changed Successfully !";
        $_SESSION['successMsg'] = $msg;
        header("refresh: 2; url=accountant-view-complete-student-voucher.php");
}


?>  

<title>Accountant | View & Complete Student Voucher</title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
    <div class="">
        <h1 class="page-heading">Complete Student Voucher</h1>
...
<div class="col-md-4">
    ...
    <input style="margin-top:0px !important" type="submit" value="Search" id="searchBtn" class="btn btn-sm float-right mt-3 btn-search" name="searchByRollNo">                        
                        ...
                        <?php
                            ...
                            $query = "select * from student_voucher where status = 'due' order by issue_date desc limit 7";
                            ...
                            ?>
                                ...
                                <td><?php echo $count; ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a onClick="return confirm('Are you sure you want to complete this Voucher !')" href="accountant-view-complete-student-voucher.php?completeId=<?php echo $id ?>" class="btn btn-primary btn-sm btn-action">Complete</a>
                                    </td>
                                </tr>
...
$(document).ready(()=>{
    ...
    jQuery.ajax({
        ...
        url:'ajax/accountant-search-view-complete-student-voucher.php',
        type: "POST",
        data:{
            sclass:sclass,
            ssection:ssection,
