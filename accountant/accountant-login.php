<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query = "select * from logins where username = '$username' and password = '$password' and type = 'accountant' ";
        ...
        if($rows > 0  )
        {
            ...
            $redirectPage = "accountant-dashboard.php";
            ...
            $redirectPage = "accountant-login.php";
...
<html lang="en">
  <head>
    ...
    <title>SIMS | Accountant Login</title>     
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center login-container">
        ...
        <form action="" class="login-form text-center" method="post" autocomplete="off" data-aos="zoom-in" data-aos-duration="2000">
            <h1 class="mb-3 font-weight-light text-uppercase">Accountant Login</h1>
            ...
            <!-- <div class="loginButton">
                <a href="accountant-dashboard.php" class="btn mt-4 btn-md btn-custom btn-block text-uppercase">Login</a>
            </div> -->
