<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query = "select * from logins where username = '$username' and password = '$password' and type = 'librarian' ";
        ...
        if($rows > 0  )
        {
            ...
            $redirectPage = "librarian-dashboard.php";
...
<html lang="en">
  <head>
    ...
    <title>SIMS | Librarian Login</title>     
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center login-container">
        ...
        <form action="" class="login-form text-center" method="post" autocomplete="off" data-aos="zoom-in" data-aos-duration="2000">
            <h1 class="mb-3 font-weight-light text-uppercase">Librarian Login</h1>
            ...
            <!-- <div class="loginButton">
                <a href="librarian-dashboard.php" class="btn mt-4 btn-md btn-custom btn-block text-uppercase">Login</a>
            </div> -->
