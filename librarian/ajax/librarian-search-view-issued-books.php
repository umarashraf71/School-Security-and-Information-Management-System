...
$status = "issued";
    ...
    else
    {
        ...
        if(!empty($_POST['search'] ) && empty($_POST['date'] ))
        {
            ...
            $query = "select * from library_issue_books where status = '$status' and CONCAT(`book_no`, `book_name`) LIKE '%".$search."%' order by issue_date desc ";
        ...
        if(!empty($_POST['search'] ) && !empty($_POST['sdate'] ))
        {
            ...
            $query = "select * from library_issue_books where status = '$status' and issue_date = '$date' and CONCAT(`book_no`, `book_name`) LIKE '%".$search."%' ";
            $result = mysqli_query($con, $query);
        ...
        if( !empty($_POST['sdate'] ) && empty($_POST['search'] ))
        {
            ...
            $query = "select * from library_issue_books where issue_date = '$date' and status = '$status' ";
            $result = mysqli_query($con, $query);
