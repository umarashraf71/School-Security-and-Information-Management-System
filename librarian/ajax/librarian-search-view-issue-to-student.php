...
include('../includes/config.php');
    ...
    //if only class and roll no is selected
    else if(!empty($_POST['sclass'] ) && empty($_POST['ssection']) && !empty($_POST['srollno']))
    {
    ...
    //if only class and section is selected
    else if(!empty($_POST['sclass'] ) && !empty($_POST['ssection']) && empty($_POST['srollno']))
    {
                ...
                <div class="table-responsive">
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                  <a href="librarian-issue-to-student.php?id=<?php echo $id; ?>" class="btn btn-success btn-sm btn-action mr-1">Issue Book</a>
                                </td>
                            </tr>
