...
if(isset($_POST['submit']))
{
    ...
    if($rowCount1 > 0)
    {
        ...
        $query2 = "insert into library_issue_books (t_id, book_id, book_no, book_name, status, type, issue_date, return_date) values ('$t_id', '$bookid', '$bookno', '$bookname', '$status', '$type', '$issuedate', '$returndate')";
    ...
    else
    {
        ...
        header("refresh: 2; url=librarian-issue-to-teacher.php?id=$editId");
    }
...
<title>Librarian | Issue to Teacher</title>
                    ...
                    <div class="card-body student-card-body">
                        ...
                        <div class="d-md-flex align-items-center">
                            <div>
                                ...
                                <h5 class="card-subtitle">Issue Book to Teacher</h5>
                            </div>
                        </div>
                        <!-- title -->
                    </div>
