<?php
    ...
    if(isset($_GET['deleteId']))
    {
            ...
            header("refresh: 2; url=librarian-view-returned-books.php");
    }


?>  

<title>Librarian | View Returned Books</title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
        <div class="">
            <h1 class="page-heading">View Returned Books</h1>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <label for="sclass" >Search by Return Date</label>
  ...
  <?php
                        ...
                        $query = "select * from library_issue_books where status = 'returned' order by l_ib_id desc limit 10 ";
    ...
    $(document).ready(() => {
        ...
        $('#searchBtn').click(() => {
            ...
            jQuery.ajax({
                ...
                url:'ajax/librarian-search-view-returned-books.php',
                type: 'POST',
                data:{
                    search:search,
                    sdate:sdate
