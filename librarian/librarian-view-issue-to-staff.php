...
<title>Librarian | View & Issue to Staff Member</title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
    <div class="">
        <h1 class="page-heading">Issue Book To Staff Member</h1>
...
<!-- <div class="row">
    ...
    <div class="row mt-2 mb-0">
        ...
        <div class="col-md-4">
            ...
            <label for="sclass" >Staff Member CNIC</label>
...
jQuery.ajax({
    ...
    url:'ajax/librarian-search-view-issue-to-staff.php',
    type: "POST",
    data:{
        cnic:cnic
    },
