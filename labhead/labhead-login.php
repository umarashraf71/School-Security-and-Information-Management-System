<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query = "select * from logins where username = '$username' and password = '$password' and type = 'labhead' ";
        ...
        if($rows > 0  )
        {
            ...
            $redirectPage = "labhead-dashboard.php";
            ...
            $redirectPage = "labhead-login.php";
...
<html lang="en">
  <head>
    ...
    <title>SIMS | Labhead Login</title>     
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center login-container">
        ...
        <form action="" class="login-form text-center" method="post" autocomplete="off" data-aos="zoom-in" data-aos-duration="2000">
            <h1 class="mb-3 font-weight-light text-uppercase">Labhead Login</h1>
