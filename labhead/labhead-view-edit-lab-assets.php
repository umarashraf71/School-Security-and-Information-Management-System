<?php
    ...
    if(isset($_GET['deleteId']))
    {
            ...
            $query2 = "delete from lab where lab_id = '$deleteId' ";
    
            mysqli_query($con, $query2);

            $msg="Lab Asset Record Deleted Successfully !";
            $_SESSION['deleteMsg'] = $msg;
            header("refresh: 2; url=labhead-view-edit-lab-assets.php");
    }

?>  


<title>Labhead | View & Edit Lab Assets</title>
...
<div class="col-md-12 mt-lg-2  mb-0">     
        <div class="">
            <h1 class="page-heading">Edit Lab Record</h1>
  ...
  <?php
                        ...
                        $query = "select * from lab order by date desc limit 7 ";
                            ...
                            <table class="table v-middle">
                                ...
                                <?php
                                    ...
                                    else
                                    {
                                        ...
                                        echo "<h3 class='pt-5'> No Lab Asset Exists !</h3>";
                                        echo "</div>";
                                    }
        ...
        $(document).ready(() => {
            ...
            $('#searchBtn').click(() => {
                ...
                jQuery.ajax({
                    ...
                    url:'ajax/labhead-search-view-edit-lab-assets.php',
                    type: 'POST',
                    data:{
                        search:search,
                        sdate:sdate
