<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query = "select * from logins where username = '$username' and password = '$password' and type = 'teacherattendence' ";
        ...
        if($rows > 0  )
        {
            ...
            $redirectPage = "teacher-attendence.php";
...
<html lang="en">
  <head>
    ...
    <title>SIMS | Teacher Attendence Login</title>     
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center login-container">
        ...
        <form action="" class="login-form text-center" method="post" autocomplete="off" data-aos="zoom-in" data-aos-duration="2000">
            <h1 class="mb-3 font-weight-light text-uppercase">Teacher Attendence Login</h1>
